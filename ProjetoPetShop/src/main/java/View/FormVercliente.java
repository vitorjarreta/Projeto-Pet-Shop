 ...
 */
public class FormVercliente extends javax.swing.JFrame {
    ...
    private void bt_pesquisarprodutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_pesquisarprodutoActionPerformed
        if (pesquisar_produto.getText().isEmpty()) {
            preencherTable(new ClientesDAO().listar());
        } else {
            preencherTable(new ClientesDAO().PesquisarNome(pesquisar_produto.getText()));
        }
    ...
    private void tabela_produtosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabela_produtosMouseClicked
        if(evt.getClickCount() == 2){
            ...
            FormCadastrarcliente f = new FormCadastrarcliente(id,1);
            f.setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormVercliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormVercliente().setVisible(true);
            }
        });
    }
    ...
    private void preencherTable(List<Clientes> lista){
        if (lista!=null) {
            if (lista.size()>0) {
                configurarTable();
